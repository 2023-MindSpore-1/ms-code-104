...
X = np.array([[.8,.6,.1],[.3,.1,.2],[0,.5,.8],[0,.5,.8]])
...
print('Score of N1 data complexity: %.4f' % dc.score(X, y))
dc = get_data_complexity('N2')
print('Score of N2 data complexity: %.4f' % dc.score(X, y))
dc = get_data_complexity('N3')
print('Score of N3 data complexity: %.4f' % dc.score(X, y))
